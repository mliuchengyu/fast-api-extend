...
class AbstractSearchServiceGenerator extends Generator
{
    /**
     * Get stub name.
     *
    ...
    {
        return $this->getBasePath() . parent::getConfigGeneratorClassPath($this->getPathConfigNode(), true) . '/' . 'AbstractSearchService.php';
    }
