...
class AbstractCriteriaGenerator extends Generator
{
    /**
     * Get stub name.
     *
    ...
    {
        return $this->getBasePath() . parent::getConfigGeneratorClassPath($this->getPathConfigNode(), true) . '/' . 'AbstractCriteria.php';
    }
