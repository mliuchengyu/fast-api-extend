...
class RepositorySearchCriteriaGenerator extends Generator
{
    /**
     * Get stub name.
     *
     * @var string
     */
    protected $stub = 'repository/criteria';
    ...
    {
        return $this->getBasePath() . parent::getConfigGeneratorClassPath($this->getPathConfigNode(), true) . '/' . $this->getName() . 'SearchCriteria.php';
    }
    ...
    public function getReplacements()
    {
        ...
        return [
            'class'          => $this->getClass(),
            'namespace' => 'namespace '.rtrim($this->getRootNamespace(),'\\').'\\'.$criteria.';',
